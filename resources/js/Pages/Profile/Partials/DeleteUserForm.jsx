    ...
    <section className={`space-y-6 ${className}`}>
      <header>
        ...
        <p className="mt-1 text-sm text-gray-600">
          ...
          download de todos os dados e informações que você tem.
        </p>
      </header>

      <div className="flex flex-col sm:flex-row gap-2">
        <SecondaryButton>Baixar dados (em breve)</SecondaryButton>
      ...
      <Modal show={confirmingUserDeletion} onClose={closeModal}>
        <form onSubmit={deleteUser} className="p-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            Depois que sua conta for excluída, todos os seus recursos e dados
            serão excluído permanentemente. Por favor, insira sua senha para
            confirmar que você gostaria de excluir permanentemente sua conta.
          </p>
